...
//if(_ae.showExport) alert(true);
//else
//  alert(_ae.showExport);
/*在分页里增加2个导出按钮 by 娄赫曦----begin*/
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
$("<td><div class=\"pagination-export\" title=\"导出当前页\" onclick=\"exportpagedata(this)\"></div></td>").appendTo(tr);
$("<td><div class=\"pagination-export-all\" title=\"导出全部\" onclick=\"exportalldata(this)\"></div></td>").appendTo(tr); 
/*在分页里增加2个导出按钮 by 娄赫曦----end*/
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,40,50],loading:false,buttons:null,showPageList:true,showRefresh:false,links:10,layout:["list","sep","first","prev","links","next","last","sep"],onSelectPage:function(_d1,_d2){
},onBeforeRefresh:function(_d3,_d4){
},onRefresh:function(_d5,_d6){
},onChangePageSize:function(_d7){
},beforePageText:"第",afterPageText:"页/ {pages}页",displayMsg:"显示 {from} 到{to}条，共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
cc.push("<span class=\"tree-title\" title=\""+opts.formatter.call(_1c1,item)+"\">"+opts.formatter.call(_1c1,item)+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
function _2af(_2b0){
    var opts=$.extend({},
            $.messager.defaults,
            {modal:false,shadow:false,draggable:false,resizable:false,closed:true,
                ...
                title:"",width:250,height:100,minHeight:0,showType:"slide",showSpeed:600,content:_2b0.msg,timeout:4000},
                _2b0);
...
$.fn.tabs.defaults={width:"100%",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:32,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_38d){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"此处为必填项！",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_48d,blur:_491,mouseenter:_494,mouseleave:_497,click:function(e){
var t=$(e.data.target);
...
,idcard:{validator:function(_42b){return /^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$|^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/i.test(_42b);},message:"请输入有效的身份证号！"}
,mobile:{validator:function(_42c){return /^(13[0-9]|14[0-9]|15[0-9]|17[0-9]|18[0-9])\d{8}$/i.test(_42c);},message:"请输入有效的手机号！"}
,disablechinese:{validator:function(_42cc){return !(/([\u4E00-\u9FA5])+/.test(_42cc));},message:"输入的内容不能包含含中文！"}
,number:{validator:function(_42d){return /^-?[0-9]\d*$/.test(_42d);},message:"请输入有效的数字！"}
,postcode:{validator:function(_42g){return /^([1-9]\d{5})$/.test(_42g);},message:"请输入有效的邮政编码！"}
,ipaddress:{validator:function(_423g){return /^([1-9]?\d|1\d\d|2[0-4]\d|25[0-5])\.([1-9]?\d|1\d\d|2[0-4]\d|25[0-5])\.([1-9]?\d|1\d\d|2[0-4]\d|25[0-5])\.([1-9]?\d|1\d\d|2[0-4]\d|25[0-5])$/.test(_423g);},message:"请输入有效的IP地址！"}
,decimalone:{validator:function(_42e){return /^(0|[1-9]\d?)(\.[0-9]{1})?$/.test(_42e);},message:"请输入有效数字！"}
,decimaltwo:{validator:function(_42e2){return /^(0|[1-9]\d?)(\.[0-9]{1,2})?$/.test(_42e2);},message:"请输入有效的小数！"}
,decimalthree:{validator:function(_42e3){return /^(0|[1-9]\d?)(\.[0-9]{1,3})?$/.test(_42e3);},message:"请输入有效的小数！"}
,decimalfour:{validator:function(_42e4){return /^(0|[1-9]\d?)(\.[0-9]{1,4})?$/.test(_42e4);},message:"请输入有效的小数！"}
,url:{validator:function(_4bc){return /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(_4bc);},message:"请输入有效的URL！"}
,phonenumber:{validator:function(_42h){return /^(0\d{2,3}-)?\d{7,8}-\d{3,4}$/.test(_42h) || /^(0\d{2,3}-)?\d{7,8}$/.test(_42h);},message:"请输入有效的电话号码！"}
,cznumber:{validator:function(_42h){return /^(0\d{2,3}-)?\d{7,8}$/.test(_42h);},message:"请输入有效的传真号码！"}
,length:{validator:function(_4bd,_4be){var len=$.trim(_4bd).length;return len>=_4be[0]&&len<=_4be[1];},message:"Please enter a value between {0} and {1}."}
,decimal:{validator:function(_42i1,_42i2){eval("var reg1423=/^(0|[1-9]\\d{0,"+_42i2[0]+"})(\\.[0-9]{1,"+_42i2[1]+"})?$/;");return reg1423.test(_42i1);},message:"请输入有效的小数！"}
,remote:{validator:function(_4bf,_4c0){
var data={};
data[_4c0[1]]=_4bf;
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"180px",height:33,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:18,buttonText:"",buttonIcon:null,buttonAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
if(col &&  String(col.width||"").indexOf("%")>=0){ //zxt
...
_6b4+=(col!=undefined && col.colspan >-1) ? col.colspan:1||1; //zxt
});
return _6b4;
};
function _6b2(a){
...
try{
    //parent.document.getElementById("rightFrame").height = window.screen.availHeight-60;
}catch(e){}
...
//}
if(opts.url !=null && opts.url.indexOf("random=") < 0) {
    if(opts.url.indexOf("?") < 0) {
        opts.url += "?random=" + Math.random();
    }else{
        opts.url += "&random=" + Math.random();
    }
}

var _755 = opts.queryParams;
if(opts.pagination){
    _755 += "&page=" + opts.pageNumber;
    _755 += "&rows=" + opts.pageSize;
}
if(opts.sortName){
    _755 += "&sort=" + opts.sortName;
    _755 += "&order=" + opts.sortOrder;
}
...
//----------------------以下是增加的内容---------------------
var cell_width = 25;
if((_7cd+"").length >= 4 && (_7cd+"").length < 7){
cell_width = 35;
}else if((_7cd+"").length > 6 && (_7cd+"").length < 9){
cell_width = 50;
}else if((_7cd+"").length > 8 && (_7cd+"").length < 11){
cell_width = 65;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div style='width:"+cell_width+"px' class=\"datagrid-cell-rownumber\">"+_7cd+"</div></td>");
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:true,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:true,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:true,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_64b(true),mouseout:_64b(false),click:_653,dblclick:_65d,contextmenu:_661},rowStyler:function(_7fd,_7fe){
...
_aa6(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_abb){
...
function openWinW2(URL,winName,winWidth,winHeight,isMax,isMin,callbackMethod){
    innerCallback=callbackMethod;
        ...
        //var boardDiv = "<div id=\"win_div_"+winName+"\" class=\"easyui-window\" title=\"My Window\" style=\"top:"+document.body.scrollTop+"
        var boardDiv = "<div id=\"win_div_"+winName+"\" class=\"easyui-window\" title=\"My Window\" style=\"width:"+winWidth+";height:"+winHeight+";padding:5px;background: #fafafa;overflow:hidden;\"><\/div>"; 
        ...
        $("#win_div_"+winName).window({title:winName,shadow: true, modal: true,maximizable:isMax,minimizable:isMin});
...
function closeWin(winName){
    ...
    { 
        if(len==1){
            innerCallback.call(this,arguments[0]);
        }else if(len==2){
...
var selectType = new Array("getStandCodeTableResult","getConfigCodeTableResult");
function loadSelect(select_obj){
    var codetable = $(select_obj).attr("codetable");//代码表名称
    if(codetable) {
        var pleaseSelected = $(select_obj).attr("pleaseSelected");//是否出现请选择选项
        var parentobject = $(select_obj).attr("parentobject");//保存上级代码的对象
        var parentcode = $(select_obj).attr("parentcode");//上级代码
        if(!parentcode) {
            parentcode = "";
        }
        //var contextPath = $(select_obj).attr("contextPath");
        //var temp_parent_val = $("#" + parentobject).val();    //获取父节点的值
        if(parentobject) {
            //$(select_obj).attr("parentcode", $("#" + parentobject).val());
            if($("#"+parentobject).attr("type")=="hidden")
            {
                parentcode = $("#"+parentobject).val();
            }else
            {
            $("#"+parentobject).bind("change",function(){
                $.ajax({
                    url:"../selectServlet?codetable=" + codetable + "&parentcode=" + this.value,
                    dataType:"json",
                    success:function(json)
                    {
                        ...
                        for(var i = 0; i < data.length; i++){
                            ...
                            option_str += "<option value='"+code+"'";
                              var select_value = $(select_obj).attr("text");
                        ...
                        $(option_str).appendTo($(select_obj));
                    }
                });
            });
            }
        ...
        var url = "../selectServlet?codetable=" + codetable + "&parentcode=" + parentcode;
        var moretable = $(select_obj).attr("moretable");//级联不在同一个表中
        if(moretable){
            para = temp_parent_val;
        }
        $.ajax({
            url: url,
            type: 'get',
            ...
            success: function(xml){
                ...
                for(var i = 0; i < data.length; i++){
                    ...
                    option_str += "<option value='"+code+"'";
                      ...
                      if( select_value &&  (select_value == code || select_value == name)) {
                        option_str += " selected"; 
                        //$("input[name='"+select_obj.id+"']").val(code);
                      }
                      option_str += ">" + name + "</option>";
                }
                $(select_obj).html("");
...
function createCombobox(select_obj){
    if(!$.data(select_obj,"combobox")){
        var editable = $(select_obj).attr("editable");//是否可以编辑
        if(!editable) {
            editable = false;
        }
        $(select_obj).combobox({editable:editable,textField:"text",onSelect:function(record){
            var textobj = $(this).attr("textobject");//将代码对应的名称保存到的页面中的元素对象
            if(textobj && textobj != "") {
                if(record.value != "") {
                    $("#" + textobj).val(record.text);
                }else{
                    $("#" + textobj).val("");
                }
            }
            var opdata = $.data(select_obj,"combobox").data;
            var opstr = "";
            for(var i = 0;i < opdata.length; i++ ) {
                opstr += "<option value='"+opdata[i].value+"'"
                if(opdata[i].value == record.value) {
                    opstr += " selected";
                }
                opstr += ">";
                opstr += opdata[i].text;
            ...
            $(select_obj).html(opstr);
            $(this).change();
            $(select_obj).css({display:"none"});
        }});
    }else{
        var _29=$.data(select_obj,"combobox").options;
        var _2a=[];
        $(">option",select_obj).each(function(num){
        var _2b={};
        _2b[_29.valueField]=$(this).attr("value");
    ...
    if($(">option[selected]",select_obj).length>0){
        var values = $(">option[selected]",select_obj)[0].value;
        var temchange = select_obj.onchange;
        select_obj.onchange = null;
        $(select_obj).combobox("select",values);
        select_obj.onchange = temchange;
    }else{
        if($(">option",select_obj).length > 0) {
            var values = $(">option",select_obj)[0].value;
            var temchange = select_obj.onchange;
            select_obj.onchange = null;
            $(select_obj).combobox("select",values);
            select_obj.onchange = temchange;
...
$(function() {
    $(".codeselect").each(function(i){
        loadSelect(this);
    });

    $(".bmtree").each(function(i){
        loadbmtree(this);
    });
    $(".rytree").each(function(i){
        loadrytree(this);
    });
});
function loadbmtree(obj)
{
    var editable = $(obj).attr("editable");
    var bmid = $(obj).attr("rootid");
    if(bmid==undefined) bmid="";
    var required = $(obj).attr("required");
    if(required==undefined) required = false;
    var checkedvalue = $(obj).attr("checkedvalue");
    ...
    if(treeid == undefined)
        treeid = "";
    var noSelectFolder = $(obj).attr("noSelectFolder");
    if(noSelectFolder==undefined)
        noSelectFolder = "";
    var usertree = $(obj).attr("usertree");
    if(usertree!=undefined&&usertree!="")
        usertree = "1";
    else
        usertree = "";
    var ultree =  $(obj).attr("ultree");
    var fullpath = $(obj).attr("fullpath");
    if(fullpath!=undefined && fullpath == "true")
        fullpath="1";
    else
        fullpath="";
    var unittree = $(obj).attr("unittree");
    if(unittree==undefined)
        unittree = "";
    if(ultree==undefined)
    {
        $(obj).combotree({
            url:'../depart/doTree.xhtml?bmid='+bmid+'&checked='+checkedvalue+"&treeid="+treeid+"&usertree="+usertree+"&fullpath="+fullpath+"&unittree="+unittree,
            editable:editable,
            required: required!="",
            multiple:multiple!="",
            cascadeCheck:false,
    ...
    //                   }
            ...
            onCheck:function(node){
                 var  node1=$(obj).tree('getParent',node.target);
                 $(obj).tree('check', node1.target);
            }
        });
        if(multiple=="" || multiple ==false){
            $(obj).combotree('setValue', {
                id: checkedvalue.toLowerCase(),
                text: ''
            });
        }
    }else
    {
        $(obj).tree({
            url:getprojectNameuri()+'depart/doTree.xhtml?bmid='+bmid+'&checked='+checkedvalue+"&usertree="+usertree+"&fullpath="+fullpath+"&unittree="+unittree,
            editable:editable,
            required: required!="",
            checkbox:multiple!="",
            cascadeCheck:false
...
function loadtree(obj)
{
    ...
    if(multiple==undefined)
        multiple = "";
    var canSelectFolder = $(obj).attr("canSelectFolder");
    if(canSelectFolder==undefined)
        canSelectFolder = "";
    var usertree = $(obj).attr("usertree");
    if(usertree!=undefined)
        ...
        usertree = "";
    alert(usertree  );
    var comboboxTree =  $(obj).attr("comboboxTree");
    if(typeof(comboboxTree)!=undefined)
    {
        $(obj).combotree({
            url:'../depart/doTree.xhtml?bmid='+bmid+'&checked='+checkedvalue+"&usertree="+usertree,
            editable:editable,
            required: required!="",
            multiple:multiple!="",
            cascadeCheck:false,
    ...
    {
        //alert(getprojectNameuri());
        $(obj).tree({
            url:getprojectNameuri()+'/depart/doTree.xhtml?bmid='+bmid+'&checked='+checkedvalue,
            editable:editable,
            required: required!="",
            multiple:multiple!="",
            cascadeCheck:false
    ...
    if(multiple=="" || multiple ==false || mutiple!=""){
        $(obj).combotree('setValue', {
            id: checkedvalue.toLowerCase(),
            text: ''
        });
...
$(function(){
      $(".previewImage").each(function(){
        ...
        "<INPUT  onchange=\"previewImage(this,'imghead"+$(this).attr("id")+"','"+$(this).attr("imgid")+"')\"  class=filePrew  id=\"file"+$(this).attr("id")+"\" name=\"file\""+ 
       " title=支持jpg、jpeg、gif、png格式， tabIndex=3 type=\"file\" size=3 name=pic  ></A>");
        $("#"+$(this).attr("imgid")).html("<image id= 'imghead"+$(this).attr("id")+"' src='image/qq.jpg'   />");
...
{
    //获取当前网址，如： http://localhost:8080/coreframe4m/index/gotoindex.xhtml  
    var curWwwPath=window.document.location.href;  
    //获取主机地址之后的目录，如： coreframe4m/index/gotoindex.xhtml
    var pathName=window.document.location.pathname;
    var pos=curWwwPath.indexOf(pathName);  
    //获取主机地址，如： http://localhost:80830 
    var localhostPaht=curWwwPath.substring(0,pos);  
    //获取带"/"的项目名，如：/coreframe4m
...
{
    return getprojectNameuri()+"common/doExcelExport.xhtml";
}
...
function exportpagedata(obj)
{
    ...
    var data=JSON.stringify($('#'+tableId).datagrid('getData').rows);
...
function exportalldata(obj)
{
    ...
    for(var item in arr){  
        if(typeof item  === 'string'){  
            var itemstring=arr[item];
            var pos=itemstring.indexOf("=");
            paramdata[itemstring.substring(0,pos)]=itemstring.substring(pos+1);
        }
    }
...
function hideexportall(){
	$('.pagination-export-all').css('display','none');
}
